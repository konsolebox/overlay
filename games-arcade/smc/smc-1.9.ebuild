...
SRC_URI="https://downloads.sourceforge.net/project/smclone/Secret%20Maryo%20Chronicles/1.9/${P}.tar.bz2
	music? ( https://downloads.sourceforge.net/project/smclone/Addon%20-%20Music/4.1/${MUSIC_P}.zip )"
