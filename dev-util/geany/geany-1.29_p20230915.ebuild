...
COMMIT=48cf4005bce716d5daa8174f4798a76dbedd3efa
SRC_URI="https://github.com/konsolebox/geany/archive/${COMMIT}.tar.gz -> ${P%_*}-konsolebox-${PV#*_p}-${COMMIT:0:8}.tar.gz
		https://github.com/ScintillaOrg/lexilla/archive/refs/tags/rel-5-2-6.tar.gz -> lexilla-5.2.6.tar.gz"
...
src_prepare() {
	rmdir "${S}/lexilla" || die
	mv "${WORKDIR}/lexilla-rel-5-2-6" "${S}/lexilla" || die
	default
