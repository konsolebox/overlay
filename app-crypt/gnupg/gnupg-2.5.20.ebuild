...
inherit autotools flag-o-matic out-of-source multiprocessing systemd toolchain-funcs verify-sig
...
IUSE="+alternatives bzip2 doc ldap nls readline run-gnupg-user-socket +run-user-socket selinux +smartcard ssl test +tofu tpm tools usb wks-server"
RESTRICT="!test? ( test )"
