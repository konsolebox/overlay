...
inherit ruby-fakegem-compat rubyexec-r1
...
RDEPEND="
	!dev-ruby/pry:ruby19
	rubyexec? ( >=dev-ruby/rubyexec-0_p20240601 )
"

ruby_add_rdepend "
	>=dev-ruby/coderay-1.1 <dev-ruby/coderay-2
	>=dev-ruby/method_source-1.0 <dev-ruby/method_source-2
