...
SLOT="0"
IUSE="apply-remote-g-packet-reply-too-long-fix cet debuginfod guile lzma multitarget nls +python +server sim source-highlight test vanilla xml xxhash zstd"
...
PATCHES=(
	...
	"${FILESDIR}/${PN}-13.2-fix-sparc-debugging.patch"
)
...
src_prepare() {
	use apply-remote-g-packet-reply-too-long-fix && \
		PATCHES+=("${FILESDIR}/${PN}-13.2-remote-g-packet-reply-too-long-fix.patch")
